...
export const clearResults = () => {
	elements.seacrhResultList.innerHTML = '';
...
const renderRecipe = recipe => {
	...
	`;
	elements.seacrhResultList.insertAdjacentHTML("beforeend", markup);
};
...
export const renderResults = (recipes, page = 1, resPerPage = 10) => {
	...
	//const arr = recipes.slice(start, end).forEach(renderRecipe);
	// Array.from(recipes).forEach(el => renderRecipe(el));
